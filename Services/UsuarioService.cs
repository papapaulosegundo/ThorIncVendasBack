...
public class UsuarioService
{
    ...
    public UsuarioService(IUnitOfWork uof)
    {
        _uof = uof;
    }
    ...
    public async Task<Usuario> Criar(Usuario usuario)
    {
        ...
        var id = await _uof.UsuarioRepository.CriarAsync(usuario);

        var criado = await _uof.UsuarioRepository.ObterPorIdAsync(id);
    ...
    {
        var usuario = await _uof.UsuarioRepository.ObterPorEmailSenhaAsync(email, senha);
    ...
    {
        var usuario = await _uof.UsuarioRepository.ObterPorIdAsync(id);
    ...
    {
        var existente = await _uof.UsuarioRepository.ObterPorIdAsync(id);
    ...
    public async Task Deletar(int id)
    {
        ...
        await _uof.UsuarioRepository.DeletarAsync(id);
    }
}